...
function ModalSuccess({ onCloseButtonClick, onReturnButtonClick }: ModalSuccessProps): JSX.Element {
  ...
  const focusOnElement = useCallback((element: HTMLAnchorElement | null) => {
    if (element) {
      element.focus();
    }
  }, []);
      ...
      <div className="modal__wrapper">
        ...
        <div className="modal__content">
          ...
          <div className="modal__buttons">
            <Link className="btn btn--transparent modal__btn" to={AppRoute.CatalogPage} onClick={() => onCloseButtonClick()} ref={focusOnElement} >
              Продолжить покупки
            </Link>
